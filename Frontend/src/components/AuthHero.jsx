      ...
      <div className="flex items-start gap-2.5">
        ...
        <div className="min-w-0">
          ...
          <p className="text-[11px] text-slate-600 leading-relaxed">
            Cut 2 cups/week → save {formatCurrency(32, currency)}/mo
          </p>
        </div>
      </div>
    </div>
        ...
        {txns.map((t, i) => {
          ...
          return (
            <div key={i} className="flex items-center justify-between">
              ...
              <span
                className={`text-[11px] font-semibold ${positive ? "text-emerald-600" : "text-slate-700"}`}
              >
                {positive ? "+" : ""}
...
const CategoryDonutCard = () => {
  ...
  const categories = [
    ...
    { name: "Rent", value: 1800, color: "bg-orange-500" },
